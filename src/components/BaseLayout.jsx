...
export default function BaseLayout({ children }) {
    ...
    return (
        <div
            className="min-h-screen w-full overflow-x-hidden flex flex-col bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 text-gray-900"
        ...
        >
            ...
            {/* Main Content */}
            <main className="flex-1 pt-24 pb-8 px-4 sm:px-6 lg:px-10 relative z-10 w-full max-w-full">
...
//     return (
//         <div
//             className="min-h-screen w-full overflow-x-hidden py-20 px-4 sm:px-6 lg:px-10 bg-gradient-to-br from-gray-100 via-gray-50 to-gray-100 text-gray-900"
//             onMouseMove={handleMouseMove}
//         >
//             {/* Pass sidebar state & toggle to Header */}
//             <Header
...
//             {/* Main Content */}
//             <main className="pt-8 min-h-full relative z-10 w-full max-w-full">
